    ...
    <div className="signup">
      <div className="signup__content">
        <div classs="align-items-center">
          ...
          <h4 style={{ marginTop: "-50px" }} className="block-center">
            {" "}
            Sign up{" "}
          </h4>
        </div>
        <div className="signup__form">
          ...
          <label for="cb1">
            <input
              type="checkbox"
              style={{ float: "left", marginTop: "3px", marginRight: "5px" }}
              id="cb1"
            />{" "}
            I agree to{" "}
            <strong>M1LKY MEET's terms of service and privacy policy</strong>
          </label>
          <button className="btn btn-large mb-20 mt-10" onClick={signup}>
            {" "}
            Sign up{" "}
          </button>
        </div>
